...
// (COLLECTION_KEY set inline in wc26_index.html / wc26_blue.html so both pages share this file
...
function initFirebase(){
  ...
  if(!looksConfigured || typeof firebase === 'undefined'){
    setSyncStatus(false, 'Not connected — edit wc26_firebase_config.js to enable live sync');
  ...
  try {
    ...
    setSyncStatus(false, 'Firebase error — check wc26_firebase_config.js');
    console.error(e);
  }
}
